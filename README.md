...
Which regions or customer groups contribute the most revenue?
...
GROUP BY for summarising data

Filtering using WHERE clauses

2. Data Analysis (Python)

The extracted data was analysed using Python to explore patterns and generate visual insights.
...
Sales performance varies across different regions and customer groups.

Historical sales trends highlight periods of increased demand for particular products.
